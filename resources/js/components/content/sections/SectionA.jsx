...
function SectionA(props) {
    ...
    useEffect(() => {
        const row1 = props.seats.filter((obj) => obj.cart_product_id < 6021);
        const row2 = props.seats.filter(
            (obj) => obj.cart_product_id < 6041 && obj.cart_product_id > 6020
        );
        const row3 = props.seats.filter(
            (obj) => obj.cart_product_id < 6065 && obj.cart_product_id > 6040
        );
        const row4 = props.seats.filter(
            (obj) => obj.cart_product_id < 6089 && obj.cart_product_id > 6064
        );
        const row5 = props.seats.filter(
            (obj) => obj.cart_product_id < 6117 && obj.cart_product_id > 6088
        );
        const row6 = props.seats.filter(
            (obj) => obj.cart_product_id < 6145 && obj.cart_product_id > 6116
        );
        const row7 = props.seats.filter(
            (obj) => obj.cart_product_id < 6177 && obj.cart_product_id > 6144
        );
        const row8 = props.seats.filter(
            (obj) => obj.cart_product_id < 6209 && obj.cart_product_id > 6176
        );
        const row9 = props.seats.filter(
            (obj) => obj.cart_product_id < 6245 && obj.cart_product_id > 6208
        );
        const row10 = props.seats.filter(
            (obj) => obj.cart_product_id < 6281 && obj.cart_product_id > 6244
        );
        const row11 = props.seats.filter(
            (obj) => obj.cart_product_id < 6321 && obj.cart_product_id > 6280
        );
        setRow1(row1);
        setRow2(row2);
        setRow3(row3);
