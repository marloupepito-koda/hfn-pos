...
function Row5(props) {
    ...
    for (let i = 0; i < 26; i++) {
        ...
        const gapColumn1 = 404.5 + 8 + 8 + 8 + 8;
        const gapColumn2 = 402.8 + 8 + 8 + 8 + 8;
        const gapColumn3 = 402.2 + 8 + 8 + 8 + 8;
        const gapColumn4 = 401.9 + 8 + 8 + 8 + 8;
        const gapColumn5 = 404.4 + 8 + 8 + 8 + 8;
        const gapColumn6 = 406.2 + 8 + 8 + 8 + 8;
        const gapColumn7 = 406.4 + 8 + 8 + 8 + 8;
        const gapColumn8 = 406.5 + 8 + 8 + 8 + 8;
        const gapColumn9 = 406.9 + 8 + 8 + 8 + 8;
        const gapColumn10 = 407.2 + 8 + 8 + 8 + 8;
        const gapColumn11 = 407.4 + 8 + 8 + 8 + 8;
        const gapColumn12 = 407.5 + 8 + 8 + 8 + 8;
        const gapColumn13 = 407 + 8 + 8 + 8 + 8;
        const gapColumn14 = 406.6 + 8 + 8 + 8 + 8;
