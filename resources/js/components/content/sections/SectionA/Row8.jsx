...
function Row8(props) {
    ...
    for (let i = 0; i < 34; i++) {
        const gapRow1 = 279.8 + i * 5.2 - 4 * 10.4;
        const gapRow2 = 279.7 + i * 5.2 - 4 * 10.4;
        const gapRow3 = 280.1 + i * 5.2 - 4 * 10.4;
        const gapRow4 = 281 + i * 5.2 - 4 * 10.4;
        const gapRow5 = 283.3 + i * 5.2 - 4 * 10.4;
        const gapRow6 = 284.2 + i * 5.2 - 4 * 10.4;
        const gapRow7 = 284.5 + i * 5.2 - 4 * 10.4;
        const gapRow8 = 284.1 + i * 5.2 - 4 * 10.4;
        const gapRow9 = 284.4 + i * 5.2 - 4 * 10.4;
        const gapRow10 = 284.6 + i * 5.2 - 4 * 10.4;
        const gapRow11 = 284.3 + i * 5.2 - 4 * 10.4;
        const gapRow12 = 283.8 + i * 5.2 - 4 * 10.4;
        const gapRow13 = 282.2 + i * 5.2 - 4 * 10.4;
        const gapRow14 = 280.5 + i * 5.2 - 4 * 10.4;
        const gapRow15 = 279.9 + i * 5.2 - 4 * 10.4;
        const gapRow16 = 280.2 + i * 5.2 - 4 * 10.4;
        const gapRow17 = 282.1 + i * 5.2 - 4 * 10.4;

        const gapColumn1 = 404.5 + 8 + 8 + 8 + 8 + 8 + 8 + 8;
        const gapColumn2 = 402.8 + 8 + 8 + 8 + 8 + 8 + 8 + 8;
        const gapColumn3 = 402.2 + 8 + 8 + 8 + 8 + 8 + 8 + 8;
        const gapColumn4 = 401.9 + 8 + 8 + 8 + 8 + 8 + 8 + 8;
        const gapColumn5 = 404.4 + 8 + 8 + 8 + 8 + 8 + 8 + 8;
        const gapColumn6 = 406.2 + 8 + 8 + 8 + 8 + 8 + 8 + 8;
        const gapColumn7 = 406.4 + 8 + 8 + 8 + 8 + 8 + 8 + 8;
        const gapColumn8 = 406.5 + 8 + 8 + 8 + 8 + 8 + 8 + 8;
        const gapColumn9 = 406.9 + 8 + 8 + 8 + 8 + 8 + 8 + 8;
        const gapColumn10 = 407.2 + 8 + 8 + 8 + 8 + 8 + 8 + 8;
        const gapColumn11 = 407.4 + 8 + 8 + 8 + 8 + 8 + 8 + 8;
        const gapColumn12 = 407.5 + 8 + 8 + 8 + 8 + 8 + 8 + 8;
        const gapColumn13 = 407 + 8 + 8 + 8 + 8 + 8 + 8 + 8;
        const gapColumn14 = 406.6 + 8 + 8 + 8 + 8 + 8 + 8 + 8;
