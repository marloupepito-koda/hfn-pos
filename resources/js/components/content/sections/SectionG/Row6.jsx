...
function Row6(props) {
    ...
    for (let i = 0; i < 26; i++) {
        const gapRow1 = 396.7 + 8 * 4;
        const gapRow2 = 395.1 + 8 * 4;
        const gapRow3 = 394.5 + 8 * 4;
        const gapRow4 = 394.2 + 8 * 4;
        const gapRow5 = 394.4 + 8 * 4;
        const gapRow6 = 395 + 8 * 4;
        const gapRow7 = 398.5 + 8 * 4;
        const gapRow8 = 398.7 + 8 * 4;
        const gapRow9 = 398.6 + 8 * 4;
        const gapRow10 = 398.8 + 8 * 4;
        const gapRow11 = 399.2 + 8 * 4;
        const gapRow12 = 399.5 + 8 * 4;
        const gapRow13 = 399.7 + 8 * 4;
        const gapRow14 = 399.8 + 8 * 4;
        const gapRow15 = 399.3 + 8 * 4;
        const gapRow16 = 296.4 + 8 * 4;
        const gapRow17 = 293.3 + 8 * 4;
        const gapRow18 = 398.9 + 8 * 4;
        const a1 = 406.6 + 8 + 8 + 8 + 9;
        const a2 = 292 + 8 + 8 + 8 + 9;
        const a3 = 406.7 + 8 + 8 + 8 + 9;
        const a4 = 291.2 + 8 + 8 + 8 + 9;
        const a5 = 406.7 + 8 + 8 + 8 + 9;
        const a6 = 290 + 8 + 8 + 8 + 9;
        const a7 = 406.7 + 8 + 8 + 8 + 9;
        const a8 = 288.9 + 8 + 8 + 8 + 9;
        const a9 = 406.6 + 8 + 8 + 8 + 9;
        const a10 = 288.1 + 8 + 8 + 8 + 9;
