...
function Row2(props) {
    ...
    for (let i = 0; i < 22; i++) {
        const gapRow1 = 396.7 + 8 * 2;
        const gapRow2 = 395.1 + 8 * 2;
        const gapRow3 = 394.5 + 8 * 2;
        const gapRow4 = 394.2 + 8 * 2;
        const gapRow5 = 394.4 + 8 * 2;
        const gapRow6 = 395 + 8 * 2;
        const gapRow7 = 398.5 + 8 * 2;
        const gapRow8 = 398.7 + 8 * 2;
        const gapRow9 = 398.6 + 8 * 2;
        const gapRow10 = 398.8 + 8 * 2;
        const gapRow11 = 399.2 + 8 * 2;
        const gapRow12 = 399.5 + 8 * 2;
        const gapRow13 = 399.7 + 8 * 2;
        const gapRow14 = 399.8 + 8 * 2;
        const gapRow15 = 399.3 + 8 * 2;
        const gapRow16 = 296.4 + 8 * 2;
        const gapRow17 = 293.3 + 8 * 2;
        const gapRow18 = 398.9 + 8 * 2;
        const a1 = 406.6;
        const a2 = 292;
        const a3 = 406.7;
        const a4 = 291.2;
        ...
        const gapColumn1 = 292.8 + i * 5.2 - 20.8;
        const gapColumn2 = 293.1 + i * 5.2 - 20.8;
        const gapColumn3 = 294.1 + i * 5.2 - 20.8;
        const gapColumn4 = 296.3 + i * 5.2 - 20.8;
        const gapColumn5 = 297.3 + i * 5.2 - 20.8;
        const gapColumn6 = 297.6 + i * 5.2 - 20.8;
        const gapColumn7 = 297.2 + i * 5.2 - 20.8;
        const gapColumn8 = 297.5 + i * 5.2 - 20.8;
        const gapColumn9 = 297.7 + i * 5.2 - 20.8;
        const gapColumn10 = 297.4 + i * 5.2 - 20.8;
        const gapColumn11 = 296.9 + i * 5.2 - 20.8;
        const gapColumn12 = 295.2 + i * 5.2 - 20.8;
        const gapColumn13 = 293.5 + i * 5.2 - 20.8;
        const gapColumn14 = 293 + i * 5.2 - 20.8;
        const gapColumn15 = 292.7 + i * 5.2 - 20.8;
        const gapColumn16 = 292.9 + i * 5.2 - 20.8;
        const gapColumn17 = 293.2 + i * 5.2 - 20.8;
